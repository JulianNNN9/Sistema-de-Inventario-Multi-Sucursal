 ...
 * OPERADOR_INVENTARIO no tiene dashboard: es un rol de ejecución operativa, el
 * panel de indicadores es para ADMIN_GENERAL (todas las sucursales) y
 * GERENTE_SUCURSAL (solo la propia; {@code branchId} lo respeta únicamente
 * ADMIN_GENERAL).
 */
