...
import { approveRebalanceSuggestion } from '../../rebalanceo/api/rebalanceo';
import { Badge, Button, Card, EmptyState, PageHeader, Select, Skeleton } from '../../../shared/components/ui';
import { ErrorAlert } from '../../../shared/components/ErrorAlert';
import { useAuth } from '../../auth/hooks/useAuth';
import { useBranches } from '../../sucursales/hooks/useBranches';
import { useDashboard } from '../hooks/useDashboard';
import { useMutation } from '../../../shared/hooks/useMutation';
import { useRebalanceSuggestions } from '../../rebalanceo/hooks/useRebalanceSuggestions';
import { useToast } from '../../../shared/context/ToastContext';
import { formatCurrency, formatNumber } from '../../../shared/lib/format';
import type { EstadoTransferenciaActivo, InventoryRotationItem } from '../types/dashboard';
import type { Sugerencia } from '../../rebalanceo/types/rebalanceo';
